...
if st.button('Run'):
    ...
    delimiter = ", "
    result_string = delimiter.join(string_list)
    input = "what scientific experimental equilibrium data are available for mixtures of s" + result_string + " at temperature " + str(temp) + " Celcius and " + str(pressure) + " bara"  
